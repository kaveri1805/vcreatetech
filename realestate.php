    ...
    <section class="pt-5" style="background-color: #FFFFFF;">
        <div class="container">
            ...
            <div class="row pt-5">
                ...
                <div class="col-md-6">
                    <h3 class="mb-3" style="color:#0D304D;">What you get with Vcreate Tech Global Real Estate Development.</h3>
                    <p>
                        We provide end-to-end real estate development services including property listing management, customer relationship tools, secure data handling, and advanced search functionalities. Whether you're creating a new real estate portal or enhancing existing services, we deliver solutions that are efficient, reliable, and user-friendly.
                    </p>
                    <a href="contact-us.php" class="btn text-white px-4 rounded-2" style="background: linear-gradient(135deg, #1a1a2e, #16213e, #0f3460);">
                        Explore Real Estate Solutions with Us
                    </a>
                </div>
            </div>
        </div>
