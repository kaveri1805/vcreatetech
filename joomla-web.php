    ...
    <section class="pt-5" style="background-color: #FFFFFF;">
        <div class="container">
            ...
            <div class="row pt-5">
                ...
                <div class="col-md-6">
                    <h3 class="mb-3" style="color:#0D304D;">What you get with Vcreate Tech Global Joomla development.</h3>
                    <p>
                        We offer customized Joomla templates, extensions, and components that enhance functionality while maintaining a seamless user experience. Our designs are built to be responsive and optimized for speed and performance across all devices.
                    </p>
                    <p>
                        We also provide regular maintenance, security updates, and technical support to ensure that your Joomla website operates smoothly and stays aligned with your business objectives.
                    </p>
                    <a href="contact-us.php" class="btn text-white px-4 rounded-2" style="background: linear-gradient(135deg, #1a1a2e, #16213e, #0f3460);">
                        Explore Joomla Development with Us
                    </a>
                </div>
            </div>
        </div>
