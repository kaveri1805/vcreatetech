function raindropsAnimationTick(instance) {
  function loop() {
    instance.ctx.clearRect(0, 0, instance.options.realWidth, instance.options.canvasHeight);
    instance.updateSprings(0.05);
    instance.renderWaves();
 ...
 color: '#1f4b77', // Sky Blue
  ...
  _create: function () {
    ...
    if (!this.options.canvasHeight) {
      this.options.canvasHeight = this.element.height();
    }
  ...
  renderWaves: function () {
    var i;
    this.ctx.fillStyle = this.options.color; // <== Apply color here
    this.ctx.beginPath();
