    ...
    <section class="pt-5" style="background-color: #FFFFFF;">
        <div class="container">
            <div class="text-center">
                <h2 class="mb-3" style="color:#0D304D;">Creative logo designs by <br> Vcreate Tech Global for brand recognition, <br> consistency, and visual impact.</h2>
                <p class="mb-5">A logo is the face of your brand. We design memorable logos that communicate your brand’s story, values, and uniqueness. Whether you’re a startup or an established business, we ensure your logo stands out in the market.</p>
            </div>
            <div class="row pt-5">
                <div class="col-md-6 mb-3">
                    <div class="uk-img rounded-4">
                        <img src="images/development/vcreatetech-logo1.png" alt="Logo Design">
                    </div>
                </div>
                <div class="col-md-6">
                    <h3 class="mb-3" style="color:#0D304D;">What you get with Vcreate Tech Global Logo Design.</h3>
                    <p>
                        A well-designed logo is more than just a symbol—it’s the cornerstone of your brand’s identity. We work closely with you to understand your vision, values, and target audience, transforming these insights into a logo that speaks for your business. Our process involves brainstorming, sketching, and refining designs until we create a logo that truly represents your brand’s essence.
                    </p>

                    <a href="contact-us.php" class="btn text-white px-4 rounded-2" style="background: linear-gradient(135deg, #1a1a2e, #16213e, #0f3460);">
                        Explore Logo Design with Us
                    </a>
                </div>
            </div>
        </div>
