    ...
    <section class="pt-5" style="background-color: #FFFFFF;">
        <div class="container">
            <div class="text-center">
                <h2 class="mb-3" style="color:#0D304D;">Reliable website maintenance by <br> Vcreate Tech Global for uptime, security, <br> and performance optimization.</h2>
                <p class="mb-5">Our website maintenance services provide you with peace of mind by ensuring your site stays current, functional, and secure. We handle updates, backups, performance tuning, and troubleshooting so you can focus on growing your business.</p>
            </div>
            <div class="row pt-5">
                <div class="col-md-6 mb-3">
                    <div class="uk-img rounded-4">
                        <img src="images/development/vcreatetech-website1.png" alt="Website Maintenance">
                    </div>
                </div>
                <div class="col-md-6">
                    <h3 class="mb-3" style="color:#0D304D;">What you get with Vcreate Tech Global Website Maintenance.</h3>
                    <p>
                        We understand that regular updates and maintenance are essential to keep your website running smoothly and securely. Our team proactively monitors site health, applies necessary patches, and optimizes performance to prevent downtime. We also provide content updates and technical support, allowing you to focus on growing your business without worrying about website issues.
                    </p>

                    <a href="contact-us.php" class="btn text-white px-4 rounded-2" style="background: linear-gradient(135deg, #1a1a2e, #16213e, #0f3460);">
                        Explore Website Maintenance with Us
                    </a>
                </div>
            </div>
        </div>
